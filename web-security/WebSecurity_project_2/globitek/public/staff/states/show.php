...
//var_dump($state_result); //debug
echo '<br/>';
//echo confirm_query($state_result); //debug
//echo $state_result; //debug statement
// No loop, only one result
$state = db_fetch_assoc($state_result);
//echo $state["id"];
//var_dump($state); //debug
?>
...
?>
    ...
    <h2>Territories</h2>
    <br />
    <a href="../territories/new.php?data=<?php echo $_GET['id']; ?>">Add a Territory</a><br />
...
<?php
    ...
    while($territory = db_fetch_assoc($territory_result)) {
      echo "<li>";
      echo "<a href=\"../territories/show.php?id=".$territory['id']." data=".urlencode($_GET['id']) ."\">";
